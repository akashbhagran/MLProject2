...
def insert_fruit(mass, width, height, colour, fruit):
    cursor.execute("INSERT INTO FRUITS (MASS, WIDTH, HEIGHT, COLOUR, FRUIT) VALUES (?, ?, ?, ?, ?)",
                   (mass, width, height, colour, fruit))
...
def make_fruit():
    ...
    if r == 1:
        ...
        insert_fruit(apple_mass, apple_width, apple_height, apple_colour, 'apple')
    elif r == 2:
        ...
        insert_fruit(mandarin_mass, mandarin_width, mandarin_height, mandarin_colour, 'mandarin')
    elif r == 3:
        ...
        insert_fruit(orange_mass, orange_width, orange_height, orange_colour, 'orange')
    elif r == 4:
        ...
        insert_fruit(lemon_mass, lemon_width, lemon_height, lemon_colour, 'lemon')
